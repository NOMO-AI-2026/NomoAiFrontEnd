    ...
    <div className="min-h-screen bg-[#F8F7FF] flex items-center justify-center p-6 font-sans text-[#1E1B4B]">
      <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        <div className={`bg-white p-8 lg:p-10 ${styles.cardShadow}`}>
          <h2 className="text-3xl font-extrabold text-[#6B21A8] mb-2">Welcome Back!</h2>
          <p className="text-sm font-bold text-gray-600 mb-8">Log in to continue your progress.</p>
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <a href="#" className="text-[11px] font-extrabold text-[#6B21A8] hover:underline">Forgot?</a>
              </div>
              <div className={`flex items-center bg-[#F8F7FF] px-4 py-3.5 ${styles.inputContainer}`}>
            ...
            <div className="flex items-center pt-2">
              <input 
                type="checkbox" 
                id="keep-signed-in" 
                className="w-4 h-4 text-[#6B21A8] border-2 border-[#6B21A8] rounded cursor-pointer"
              />
              <label htmlFor="keep-signed-in" className="ml-3 text-xs font-extrabold text-[#1E1B4B] cursor-pointer">
                Keep me signed in
              </label>
            </div>
            ...
            <button 
              type="button" 
              className={`w-full bg-[#FACC15] hover:bg-[#f4c40b] text-[#1E1B4B] font-extrabold text-[15px] py-3.5 rounded-full flex justify-center items-center gap-2 mt-2 ${styles.buttonShadow}`}
            >
              Login
          ...
          <div className="mt-8 text-center text-xs font-bold text-gray-500">
            Don't have an account? <a href="/signup" className="text-[#6B21A8] hover:underline ml-1">Sign up for free</a>
          </div>
        </div>
      </div>
